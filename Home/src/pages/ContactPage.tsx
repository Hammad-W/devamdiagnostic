      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 w-full">
        <div className="mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-2xl">
            Have questions about our diagnostic services or want to schedule a
            home collection? Reach out to our team in Patna.
          </p>
        </div>
          ...
          <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 mt-1">
                      123 Health Plaza, Bailey Road, Patna, Bihar 800001, India
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
            ...
            <div className="bg-slate-100 p-8 rounded-xl border-t-4 border-[#008080] shadow-sm">
              ...
              <p className="text-slate-600 mb-6">
                Need instant help? Connect with our support team directly via
                WhatsApp.
              </p>
