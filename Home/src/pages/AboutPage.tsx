  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-background-light font-display text-slate-900">
      <main className="flex-1">
              ...
              <div className="flex-1 flex flex-col justify-between h-full">
                <div>
                  ...
                  <p className="text-xl text-slate-600 font-medium mb-6">
                    MBBS, MD - AIIMS Trained Radiologist
                  </p>
                  ...
                  <p className="text-slate-600 max-w-2xl leading-relaxed mb-8">
                    Dr. Pankaj Kumar is a highly distinguished radiologist with
                    specialized training from AIIMS. He leads the advanced
                    imaging department at Devam Diagnostic Center, specializing
                    in complex neuro and musculoskeletal diagnostics.
                  </p>
                </div>
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="border-b border-slate-200 mb-8 overflow-x-auto">
            <div className="flex gap-8 min-w-max">
              <button className="pb-4 text-sm font-bold border-b-2 border-transparent text-slate-500 hover:text-primary transition-colors cursor-pointer">
                Biography
              </button>
              <button className="pb-4 text-sm font-bold border-b-2 border-transparent text-slate-500 hover:text-primary transition-colors cursor-pointer">
                Education & Experience
              </button>
              <button className="pb-4 text-sm font-bold border-b-2 border-primary text-primary cursor-pointer">
                Specializations
              </button>
              <button className="pb-4 text-sm font-bold border-b-2 border-transparent text-slate-500 hover:text-primary transition-colors cursor-pointer">
                Publications
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-4">
              ...
              <p className="text-slate-600">
                Expertise in 3T MRI, Functional MRI (fMRI), and Diffusion Tensor
                Imaging for neuro-surgical planning.
              </p>
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-4">
              ...
              <p className="text-slate-600">
                High-resolution multi-slice CT scans including cardiac calcium
                scoring and virtual colonoscopy.
              </p>
              <ul className="space-y-2 mt-2">
                <li className="flex items-center gap-2 text-sm text-slate-500">
                  <CheckCircle2 className="w-4 h-4 text-accent-teal" />
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-4">
              ...
              <p className="text-slate-600">
                Minimally invasive image-guided procedures for diagnosis and
                treatment of complex vascular conditions.
              </p>
              <ul className="space-y-2 mt-2">
                <li className="flex items-center gap-2 text-sm text-slate-500">
                  <CheckCircle2 className="w-4 h-4 text-accent-teal" />
        ...
        <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="text-slate-500">
                Real stories from Dr. Kumar&apos;s patients
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 italic text-slate-600 relative">
              ...
              &quot;Dr. Kumar&apos;s diagnostic accuracy saved my father&apos;s
              life. His report was so detailed that the surgeons knew exactly
              what to expect. Truly the best radiologist in Patna.&quot;
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 italic text-slate-600 relative">
              <Quote className="w-12 h-12 text-primary/10 absolute top-4 right-4 rotate-180" />
              &quot;Very professional and calm. He took the time to explain the
              procedure to me, which helped ease my anxiety about the CT scan.
              Highly recommended.&quot;
              <div className="mt-6 flex items-center gap-4 not-italic">
                <div className="w-10 h-10 rounded-full bg-slate-200"></div>
                <div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 italic text-slate-600 relative hidden lg:block">
              <Quote className="w-12 h-12 text-primary/10 absolute top-4 right-4 rotate-180" />
              &quot;The level of detail in the MRI report was praised even by my
              consultant in Mumbai. Devam Diagnostic and Dr. Kumar are
              world-class.&quot;
              <div className="mt-6 flex items-center gap-4 not-italic">
                <div className="w-10 h-10 rounded-full bg-slate-200"></div>
                <div>
        ...
        {/* Contact summary footer from original page */}
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-xl font-bold text-slate-900">
                    Devam Diagnostic Center
                  </span>
                </div>
                <p className="text-slate-500 max-w-sm mb-6">
                  Pioneering diagnostic excellence in Patna with
                  state-of-the-art imaging and laboratory services since 2008.
                </p>
            ...
            <div className="border-t border-slate-100 mt-12 pt-8 text-center">
              <p className="text-sm text-slate-400">
                © 2024 Devam Diagnostic Center. All Rights Reserved.
              </p>
            </div>
          </div>
        </section>
