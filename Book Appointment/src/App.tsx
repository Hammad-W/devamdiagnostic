        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="text-[#1152d4] bg-[#1152d4]/10 p-1.5 rounded-lg">
                <Activity size={24} strokeWidth={2.5} />
              </div>
              <span className="text-xl font-bold tracking-tight">Devam Diagnostic</span>
            </div>
            <nav className="hidden md:flex items-center gap-8">
              <a href="#" className="text-sm font-medium hover:text-[#1152d4] transition-colors">Home</a>
              <a href="#" className="text-sm font-medium hover:text-[#1152d4] transition-colors">Services</a>
              <a href="#" className="text-sm font-medium hover:text-[#1152d4] transition-colors">About Us</a>
              <a href="#" className="text-sm font-medium hover:text-[#1152d4] transition-colors">Contact</a>
              <button className="bg-[#1152d4] text-white px-5 py-2 rounded-lg text-sm font-bold hover:bg-[#1152d4]/90 transition-all">
                Support
              </button>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <nav className="flex text-sm text-slate-500 mb-4 items-center gap-2">
            <a href="#" className="hover:text-[#1152d4]">Home</a>
            <ChevronRight size={14} />
            <span className="text-slate-900 font-medium">Book Appointment</span>
          </nav>
          <h1 className="text-3xl md:text-4xl font-black tracking-tight text-slate-900">Book Your Diagnostic Appointment</h1>
        </div>
        ...
        <p className="text-slate-600 mb-8 max-w-2xl text-lg">
          Schedule your clinical tests at our Patna main center. Our team ensures a quick and comfortable experience.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {services.map((s, i) => (
                  <button 
                    ...
                    className={`flex flex-col items-start p-4 border-2 rounded-xl text-left transition-all ${selectedService === i ? 'border-[#1152d4] bg-[#1152d4]/5' : 'border-slate-200 hover:border-[#1152d4]/50'}`}
                  >
                ...
                <div>
                  ...
                  <div className="p-4 border border-slate-200 rounded-xl">
                    ...
                    <div className="grid grid-cols-7 gap-1 text-center text-sm">
                      ...
                      <div className="p-2 bg-[#1152d4] text-white font-bold rounded cursor-pointer shadow-md">5</div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {slots.map((slot, i) => (
                      <button 
                        ...
                        className={`py-2.5 px-3 border-2 rounded-lg text-sm transition-colors ${selectedSlot === i ? 'border-[#1152d4] bg-[#1152d4]/5 font-bold text-[#1152d4]' : 'border-slate-200 hover:bg-[#1152d4]/5 hover:border-[#1152d4]/50'}`}
                      >
                        {slot}
                      </button>
                    ))}
            ...
            <section className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" placeholder="John Doe" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1152d4]/50 transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700">Phone Number</label>
                  <input type="tel" placeholder="+91 98765 43210" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1152d4]/50 transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700">Age</label>
                  <input type="number" placeholder="25" className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1152d4]/50 transition-all" />
                </div>
                <div className="space-y-2">
          ...
          <aside className="space-y-6">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="p-6 space-y-6">
                <div className="flex justify-between items-start">
                  <div>
                    <p className="text-xs text-slate-500 uppercase font-bold tracking-wider mb-1">Service Selected</p>
                    <p className="text-lg font-bold text-slate-900">{services[selectedService].name}</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium text-slate-700">Thursday, Oct 5, 2023</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Clock size={18} className="text-slate-400" />
                    <span className="text-sm font-medium text-slate-700">{slots[selectedSlot]} Slot</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin size={18} className="text-slate-400" />
                    <span className="text-sm font-medium text-slate-700">Patna Main Center, Kankarbagh</span>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-slate-100">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm font-medium">{services[selectedService].price.replace(' average', '')}</span>
                  </div>
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-sm text-slate-500">Consultation</span>
                    <span className="text-sm text-teal-600 font-medium italic">Included</span>
                  </div>
                  <div className="flex justify-between items-center pt-2">
                    <span className="text-lg font-bold">Total Estimated</span>
                    <span className="text-2xl font-black text-[#1152d4]">{services[selectedService].price.replace(' average', '')}</span>
                  </div>
                </div>
              </div>
              
              <div className="bg-slate-50 p-4 text-center border-t border-slate-100">
                <p className="text-[10px] text-slate-500 uppercase font-bold tracking-widest">Payment will be collected at the center</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#1152d4] to-blue-700 rounded-xl p-6 text-white shadow-lg">
              ...
              <p className="text-blue-100 text-sm mb-5 leading-relaxed">Our patient coordinators are available 24/7 to assist you with scheduling.</p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
        ...
        <footer className="mt-16 pt-8 border-t border-slate-200 text-center pb-12">
          <p className="text-slate-500 text-sm">© 2023 Devam Diagnostic Center Patna. All diagnostic procedures are performed by certified professionals.</p>
          <div className="flex justify-center gap-6 mt-4">
            <a href="#" className="text-slate-400 hover:text-[#1152d4] transition-colors flex items-center gap-1.5 text-sm">
